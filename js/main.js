...
/* Destaca no menu nav aplicando uma sombra*/ 
...
/* Slider Swiper da seção Dicas, implementa o dinamismo e responsividade do swiper */
...
/*Scroll Reveal: Efeito Mostrar elementos quando der scroll na página*/
...
scrollReveal.reveal(
  `#home .image, #home .text, #matricula, #matricula .title-format #cursos header, #cursos .card, #dicas header, #about .text, #about .links, footer .brand, footer .social`,
  { interval: 200 }
)
